  ...
  return (
    <div>
     <div className="bg-white con-bg">
      <div className='flex items-center w-auto text-center door skyace
      '>
        <h3 className="text-5xl font-extrabold tracking-normal text-center z-1 text-white">Skyace</h3>
      </div>
      <div className="mx-auto grid max-w-2xl grid-cols-1 items-center gap-x-8 gap-y-16 px-4 py-24 sm:px-6 sm:py-32 lg:max-w-7xl lg:grid-cols-2 lg:px-8">
        <div>
          <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Skyace</h2>
